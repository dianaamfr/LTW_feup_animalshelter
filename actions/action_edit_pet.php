<?php
    ...
    $description = validate_complex_string($_POST['description'],'Description');
    ...
    updatePet($petId, $name, $speciesId, $breed, $sizeId, $genderId, $age, $colorId, $description, $location, $date);
    ...
    $numberOfPetImages = 4 - getNumberOfImages($petId)['count'];

    // Upload and Insert Images in the database
    $max_files = ($input_files_count < $numberOfPetImages) ? $input_files_count : $numberOfPetImages;
    $uploaded = 0;
